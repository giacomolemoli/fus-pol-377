...
More generally, you must reflect on the difference between using AI to help [you]{.alert} learn and allow [your]{.alert} unique talents to emerge **and** using AI to pretend you have learned
