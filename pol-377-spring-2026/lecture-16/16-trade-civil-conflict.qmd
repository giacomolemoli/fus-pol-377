...
- Submission [deadline]{.alert} April 24 on Moodle as a single PDF document.
...
- Specifics of the research design (rest of the document) $\rightarrow$ follow the structure that we have used throughout the course
...
In the last week of class, we will have two presentation sessions
...
However, most armed conflicts happen within country borders
...
A large number of countries has been affected by civil conflicts or wars in the post-WWII period
...
- Government-FARC ceasefire deal (2016) and disarming, violence between the state and former FARC factions remain
