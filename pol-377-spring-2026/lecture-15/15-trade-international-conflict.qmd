...
- Consider calculations about the future as an important mechanism
...
## Classic approaches (from our first class)
...
![](img/Adam_Smith_The_Muir_portrait.jpg){width="30%"}
...
![](img/Portrait_of_Niccol%C3%B2_Machiavelli_by_Santi_di_Tito.jpg){width="30%"}
...
- Incorporate the realist assumption that power matters and states pursue it, but adopt the perspective that institutions constrain single actors
- This framework allows for both frameworks' predictions to hold in some cases
...
:::
::: {.column width="60%"}
- Democracy and economic interdependence associated with lower likelihood of militarized conflict. The association with shared IGO memberships is among "politically relevant" dyads (i.e., contiguous states or containing major powers)
- "Realist" factors such as power imbalance and geographic distanc are associated with disputes
...
# Concerns about the future {.section}
...
- Incorporates liberal insights ($\rightarrow$ benefits of trade incentivize peace) and realist concern ($\rightarrow$ vulnerability to trade break can push to war)
